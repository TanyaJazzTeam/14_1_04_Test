...
- со связанными за спиной руками и шаровым отверстием в затылке.
...
Если бы мешки предназначались для трупов военнослужащих РФ, то это бы означало, что россияне, собрав 200 тысяч солдат для вторжения, запланировали безвозвратные потери на уровне 22.5% и суммарные потери (вместе с ранеными) на уровне 90% от общей численности нереальной группировки. [^2].
